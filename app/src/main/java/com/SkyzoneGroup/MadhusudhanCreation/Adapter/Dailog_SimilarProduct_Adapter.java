...
public class Dailog_SimilarProduct_Adapter extends RecyclerView.Adapter<View_Holder> {

    Dailog_SimilarFragment context;
    List<Subcatdatamodel> dataSet;
    String USER_ID;

    private static final StrikethroughSpan STRIKE_THROUGH_SPAN = new StrikethroughSpan();

    public Dailog_SimilarProduct_Adapter(List<Subcatdatamodel> data, Dailog_SimilarFragment context, String USER_ID) {
        this.dataSet = data;
